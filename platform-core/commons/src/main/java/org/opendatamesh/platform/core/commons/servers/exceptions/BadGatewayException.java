 ...
 */
public class BadGatewayException extends ODMApiException {

	public BadGatewayException(ODMApiStandardErrors error, String message) {
		super(error, message);
	}
	...
	public BadGatewayException(ODMApiStandardErrors error, String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
		super(error, message, cause, enableSuppression, writableStackTrace);
	}


	public BadGatewayException(ODMApiStandardErrors error, String message, Throwable cause) {
