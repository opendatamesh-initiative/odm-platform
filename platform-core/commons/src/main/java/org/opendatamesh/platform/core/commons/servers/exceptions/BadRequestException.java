...
public class BadRequestException extends ODMApiException {
	...
	public BadRequestException(ODMApiStandardErrors error, String message, Throwable cause,
	...
	public BadRequestException(ODMApiStandardErrors error, String message) {
		super(error, message);
	}
