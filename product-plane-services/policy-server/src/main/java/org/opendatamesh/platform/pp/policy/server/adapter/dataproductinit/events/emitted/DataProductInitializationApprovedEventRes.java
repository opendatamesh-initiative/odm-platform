...
public class DataProductInitializationApprovedEventRes {
    private final String resourceType = "DATA_PRODUCT";
    private String resourceIdentifier;
    private final String type = NotificationV2EventType.DATA_PRODUCT_INITIALIZATION_APPROVED.getValue();
    private final String eventTypeVersion = "v2.0.0";
    private EventContent eventContent;

    public DataProductInitializationApprovedEventRes() {
    }
