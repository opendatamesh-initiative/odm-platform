...
public class DataProductVersionPublicationRejectedEventRes {
    private Long sequenceId;
    private final String resourceType = "DATA_PRODUCT_VERSION";
    private String resourceIdentifier;
    private final String type = NotificationV2EventType.DATA_PRODUCT_VERSION_PUBLICATION_REJECTED.getValue();
    private final String eventTypeVersion = "v2.0.0";
    private EventContent eventContent;

    public DataProductVersionPublicationRejectedEventRes() {
    }
