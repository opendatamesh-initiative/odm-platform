...
public class ODMPolicyResourceBuilder {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ODMPolicyResourceBuilder.class);

    public ODMPolicyResourceBuilder() {
