...
public enum OpenDataMeshAPIStandardError {
    ...
    SC400_12_TEMPLATE_IS_EMPTY ("40012", "Template is empty"),
    SC400_13_TEMPLATE_ID_IS_EMPTY ("40013", "Template id is empty"),
    ...
    SC404_04_TEMPLATE_NOT_FOUND ("40404", "Template not found"),
    ...
    SC422_10_TEMPLATE_ALREADY_EXISTS ("42210", "Template already exists"),
    SC422_11_TEMPLATE_DOC_SYNTAX_IS_INVALID ("42211", "Template document is invalid"),
