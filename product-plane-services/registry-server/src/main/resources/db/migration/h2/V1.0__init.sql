...
ALTER TABLE "ODMREGISTRY"."DPV_ACTIVITY_INFOS" ADD CONSTRAINT "ODMREGISTRY"."C_FK2_DPV_ACTIVITY_INFOS" FOREIGN KEY("TEMPLATE_ID") REFERENCES "ODMREGISTRY"."DPV_TEMPLATE_STD_DEFS"("INSTANCE_ID") NOCHECK;
