...
CREATE MEMORY TABLE "ODMREGISTRY"."DPV_TASK_INFOS"(
    "DATA_PRODUCT_ID" CHARACTER VARYING(255),
    "DATA_PRODUCT_VERSION" CHARACTER VARYING(255),
...
ALTER TABLE "ODMREGISTRY"."DPV_TASK_INFOS" ADD CONSTRAINT "ODMREGISTRY"."C_PK_DPV_TASK_INFOS" PRIMARY KEY("ID");
...
CREATE MEMORY TABLE "ODMREGISTRY"."DPV_VARIABLES"(
    "ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,

    "DATA_PRODUCT_ID" CHARACTER VARYING(255) NOT NULL,
    "DATA_PRODUCT_VERSION" CHARACTER VARYING(255) NOT NULL,

    "VARIABLE_NAME" CHARACTER VARYING(500) NOT NULL,
    "VARIABLE_VALUE" CHARACTER VARYING(255)
);
ALTER TABLE "ODMREGISTRY"."DPV_VARIABLES" ADD CONSTRAINT "ODMREGISTRY"."C_PK_DPV_VARIABLES" PRIMARY KEY("ID");


-- API DEFINITIONS ============================================

CREATE MEMORY TABLE "ODMREGISTRY"."DPV_API_STD_DEFS"(
    "INSTANCE_ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "ID" CHARACTER VARYING(255) NOT NULL,
    "FQN" CHARACTER VARYING(255),
    "ENTITY_TYPE" CHARACTER VARYING(255),
    "NAME" CHARACTER VARYING(255),
...
ALTER TABLE "ODMREGISTRY"."DPV_API_STD_DEFS" ADD CONSTRAINT "ODMREGISTRY"."C_PK_DPV_API_STD_DEFS" PRIMARY KEY("INSTANCE_ID");

CREATE MEMORY TABLE "ODMREGISTRY"."APIS"(
    "ID" CHARACTER VARYING(255) NOT NULL,
    "FQN" CHARACTER VARYING(255),
    "ENTITY_TYPE" CHARACTER VARYING(255),
    "NAME" CHARACTER VARYING(255),
...
ALTER TABLE "ODMREGISTRY"."APIS" ADD CONSTRAINT "ODMREGISTRY"."C_PK_APIS" PRIMARY KEY("ID");
...
CREATE MEMORY TABLE "ODMREGISTRY"."DPV_TEMPLATE_STD_DEFS"(
    "INSTANCE_ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "ID" CHARACTER VARYING(255) NOT NULL,
    "FQN" CHARACTER VARYING(255),
    "ENTITY_TYPE" CHARACTER VARYING(255),
...
ALTER TABLE "ODMREGISTRY"."DPV_TEMPLATE_STD_DEFS" ADD CONSTRAINT "ODMREGISTRY"."C_PK_DPV_TEMPLATE_STD_DEFS" PRIMARY KEY("INSTANCE_ID");

CREATE MEMORY TABLE "ODMREGISTRY"."TEMPLATES"(
    "ID" CHARACTER VARYING(255) NOT NULL,
    "FQN" CHARACTER VARYING(255),
    "ENTITY_TYPE" CHARACTER VARYING(255),
    "NAME" CHARACTER VARYING(255),
...
ALTER TABLE "ODMREGISTRY"."TEMPLATES" ADD CONSTRAINT "ODMREGISTRY"."C_PK_TEMPLATES" PRIMARY KEY("ID");
...
ALTER TABLE "ODMREGISTRY"."DOMAINS" ADD CONSTRAINT "ODMREGISTRY"."C_PK_DOMAINS" PRIMARY KEY("DOMAIN_ID");
...
ALTER TABLE "ODMREGISTRY"."DPV_PORT_PROMISES" ADD CONSTRAINT "ODMREGISTRY"."C_FK3_DPV_PORT_PROMISES" FOREIGN KEY("API_ID") REFERENCES "ODMREGISTRY"."DPV_API_STD_DEFS"("INSTANCE_ID") NOCHECK;
...
ALTER TABLE "ODMREGISTRY"."DPV_TASK_INFOS" ADD CONSTRAINT "ODMREGISTRY"."C_FK3_DPV_TASK_INFOS" FOREIGN KEY("DATA_PRODUCT_ID", "DATA_PRODUCT_VERSION") REFERENCES "ODMREGISTRY"."DP_VERSIONS"("DATA_PRODUCT_ID", "VERSION_NUMBER") NOCHECK;
ALTER TABLE "ODMREGISTRY"."DPV_TASK_INFOS" ADD CONSTRAINT "ODMREGISTRY"."C_FK1_DPV_TASK_INFOS" FOREIGN KEY("SERVICE_ID") REFERENCES "ODMREGISTRY"."DPV_EXTERNAL_RESOURCES"("ID") NOCHECK;
ALTER TABLE "ODMREGISTRY"."DPV_TASK_INFOS" ADD CONSTRAINT "ODMREGISTRY"."C_FK2_DPV_TASK_INFOS" FOREIGN KEY("TEMPLATE_ID") REFERENCES "ODMREGISTRY"."DPV_TEMPLATE_STD_DEFS"("INSTANCE_ID") NOCHECK;
...
-- DPV_VARIABLES FKs
ALTER TABLE "ODMREGISTRY"."DPV_VARIABLES" ADD CONSTRAINT "ODMREGISTRY"."C_FK1_DPV_VARIABLES" FOREIGN KEY("DATA_PRODUCT_ID", "DATA_PRODUCT_VERSION") REFERENCES "ODMREGISTRY"."DP_VERSIONS"("DATA_PRODUCT_ID", "VERSION_NUMBER") NOCHECK;
