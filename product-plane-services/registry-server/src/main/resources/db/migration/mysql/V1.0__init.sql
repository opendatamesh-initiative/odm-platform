...
ALTER TABLE DATA_PRODUCT_VERSIONS ADD CONSTRAINT C_PK_DATA_PRODUCT_VERSIONS PRIMARY KEY (DATA_PRODUCT_ID, VERSION_NUMBER);


-- INFO_OWNERS

CREATE TABLE INFO_OWNERS(
    ID  VARCHAR(255) PRIMARY KEY,
    NAME  VARCHAR(255)
);
...
CREATE TABLE INFO_CONTACT_POINTS(
    DATA_PRODUCT_ID  VARCHAR(255) NOT NULL,
    VERSION_NUMBER  VARCHAR(255) NOT NULL,
    NAME  VARCHAR(255),
    DESCRIPTION  VARCHAR(255),
...
ALTER TABLE DATA_PRODUCT_VERSIONS ADD CONSTRAINT C_FK1_DATA_PRODUCT_VERSIONS FOREIGN KEY(OWNER_ID) REFERENCES INFO_OWNERS(ID);
ALTER TABLE DATA_PRODUCT_VERSIONS ADD CONSTRAINT C_FK2_DATA_PRODUCT_VERSIONS FOREIGN KEY(EXTERNAL_DOC_ID) REFERENCES DPDS_EXTERNAL_RESOURCES(ID);


ALTER TABLE INFO_CONTACT_POINTS ADD CONSTRAINT C_FK_INFO_CONTACT_POINTS FOREIGN KEY(DATA_PRODUCT_ID, VERSION_NUMBER) REFERENCES DATA_PRODUCT_VERSIONS(DATA_PRODUCT_ID, VERSION_NUMBER);
ALTER TABLE DPDS_PORTS ADD CONSTRAINT C_FK_PORTS FOREIGN KEY(DATA_PRODUCT_ID, VERSION) REFERENCES DATA_PRODUCT_VERSIONS(DATA_PRODUCT_ID, VERSION_NUMBER);
ALTER TABLE DPDS_APP_COMPONENTS ADD CONSTRAINT C_FK_APP_COMPONENTS FOREIGN KEY(DATA_PRODUCT_ID, VERSION) REFERENCES DATA_PRODUCT_VERSIONS(DATA_PRODUCT_ID, VERSION_NUMBER);
ALTER TABLE DPDS_INFRA_COMPONENTS ADD CONSTRAINT C_FK_INFRA_COMPONENTS FOREIGN KEY(DATA_PRODUCT_ID, VERSION) REFERENCES DATA_PRODUCT_VERSIONS(DATA_PRODUCT_ID, VERSION_NUMBER);
ALTER TABLE DPDS_DATA_PRODUCT_TAGS ADD CONSTRAINT C_FK_DATA_PRODUCT_TAGS FOREIGN KEY(DATAPRODUCT_ID, VERSION) REFERENCES DATA_PRODUCT_VERSIONS(DATA_PRODUCT_ID, VERSION_NUMBER);
