...
CREATE TABLE DPDS_APP_COMPONENT_TEMPLATE(
    APP_COMPONENT_ID BIGINT NOT NULL,
    TEMPLATE_ID BIGINT NOT NULL
)
ALTER TABLE DPDS_APP_COMPONENT_TEMPLATE ADD CONSTRAINT DPDS_APP_COMPONENT_TEMPLATE_PK PRIMARY KEY (APP_COMPONENT_ID, TEMPLATE_ID);
...
ALTER TABLE DPDS_APP_COMPONENT_TEMPLATE ADD CONSTRAINT CONSTRAINT_DPDS_APP_COMPONENT_TEMPLATE_FK1 FOREIGN KEY(APP_COMPONENT_ID) REFERENCES DPDS_APP_COMPONENTS(ID);
ALTER TABLE DPDS_APP_COMPONENT_TEMPLATE ADD CONSTRAINT CONSTRAINT_DPDS_APP_COMPONENT_TEMPLATE_FK2 FOREIGN KEY(TEMPLATE_ID) REFERENCES DPDS_TEMPLATE(ID);