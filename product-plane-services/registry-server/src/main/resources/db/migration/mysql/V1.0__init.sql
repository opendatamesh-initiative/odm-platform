...
ALTER TABLE DPV_APP_COMPONENT_BUILD_INFOS ADD CONSTRAINT C_FK2_DPV_APP_COMPONENT_BUILD_INFOS FOREIGN KEY(TEMPLATE_ID) REFERENCES DEF_TEMPLATES(ID);


ALTER TABLE DPV_APP_COMPONENT_DEPLOY_INFOS ADD CONSTRAINT C_FK1_DPV_APP_COMPONENT_DEPLOY_INFOS FOREIGN KEY(SERVICE_ID) REFERENCES DPV_EXTERNAL_RESOURCES(ID);
ALTER TABLE DPV_APP_COMPONENT_DEPLOY_INFOS ADD CONSTRAINT C_FK2_DPV_APP_COMPONENT_DEPLOY_INFOS FOREIGN KEY(TEMPLATE_ID) REFERENCES DEF_TEMPLATES(ID);
...
ALTER TABLE DPV_INFRA_PROVISION_INFOS ADD CONSTRAINT C_FK1_DPV_INFRA_PROVISION_INFOS FOREIGN KEY(SERVICE_ID) REFERENCES DPV_EXTERNAL_RESOURCES(ID);
ALTER TABLE DPV_INFRA_PROVISION_INFOS ADD CONSTRAINT C_FK2_DPV_INFRA_PROVISION_INFOS FOREIGN KEY(TEMPLATE_ID) REFERENCES DEF_TEMPLATES(ID);
