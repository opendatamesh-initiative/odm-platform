...
ALTER TABLE DPV_ACTIVITY_INFOS ADD CONSTRAINT C_FK2_DPV_ACTIVITY_INFOS FOREIGN KEY(TEMPLATE_ID) REFERENCES DPV_TEMPLATE_STD_DEFS(INSTANCE_ID) ON DELETE CASCADE;
