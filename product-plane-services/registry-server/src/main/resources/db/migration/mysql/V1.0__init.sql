...
ALTER TABLE DPV_APP_COMPONENTS ADD CONSTRAINT C_FK2_DPV_APP_COMPONENTS FOREIGN KEY(BUILD_INFO_ID) REFERENCES DPV_APP_COMPONENT_BUILD_INFOS(ID) ON DELETE CASCADE;
ALTER TABLE DPV_APP_COMPONENTS ADD CONSTRAINT C_FK3_DPV_APP_COMPONENTS FOREIGN KEY(DEPLOY_INFO_ID) REFERENCES DPV_APP_COMPONENT_DEPLOY_INFOS(ID) ON DELETE CASCADE;
...
ALTER TABLE DPV_APP_COMPONENT_BUILD_INFOS ADD CONSTRAINT C_FK1_DPV_APP_COMPONENT_BUILD_INFOS FOREIGN KEY(SERVICE_ID) REFERENCES DPV_EXTERNAL_RESOURCES(ID) ON DELETE CASCADE;
ALTER TABLE DPV_APP_COMPONENT_BUILD_INFOS ADD CONSTRAINT C_FK2_DPV_APP_COMPONENT_BUILD_INFOS FOREIGN KEY(TEMPLATE_ID) REFERENCES DEF_TEMPLATES(ID) ON DELETE CASCADE;


ALTER TABLE DPV_APP_COMPONENT_DEPLOY_INFOS ADD CONSTRAINT C_FK1_DPV_APP_COMPONENT_DEPLOY_INFOS FOREIGN KEY(SERVICE_ID) REFERENCES DPV_EXTERNAL_RESOURCES(ID) ON DELETE CASCADE;
ALTER TABLE DPV_APP_COMPONENT_DEPLOY_INFOS ADD CONSTRAINT C_FK2_DPV_APP_COMPONENT_DEPLOY_INFOS FOREIGN KEY(TEMPLATE_ID) REFERENCES DEF_TEMPLATES(ID) ON DELETE CASCADE;
...
ALTER TABLE DPV_INFRA_COMPONENTS ADD CONSTRAINT C_FK2_DPV_INFRA_COMPONENTS FOREIGN KEY(PROVISION_INFO_ID) REFERENCES DPV_INFRA_PROVISION_INFOS(ID) ON DELETE CASCADE;
...
ALTER TABLE DPV_INFRA_PROVISION_INFOS ADD CONSTRAINT C_FK1_DPV_INFRA_PROVISION_INFOS FOREIGN KEY(SERVICE_ID) REFERENCES DPV_EXTERNAL_RESOURCES(ID) ON DELETE CASCADE;
ALTER TABLE DPV_INFRA_PROVISION_INFOS ADD CONSTRAINT C_FK2_DPV_INFRA_PROVISION_INFOS FOREIGN KEY(TEMPLATE_ID) REFERENCES DEF_TEMPLATES(ID) ON DELETE CASCADE;
