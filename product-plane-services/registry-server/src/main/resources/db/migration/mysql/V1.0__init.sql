...
ALTER TABLE DPDS_STANDARD_DEFINITIONS ADD CONSTRAINT FKN28C6VYQCY0S460D5WB2VO4R0 FOREIGN KEY(EXTERNAL_DOC_ID) REFERENCES DPV_EXTERNAL_RESOURCES(ID);

ALTER TABLE DPDS_STANDARD_DEFINITIONS ADD CONSTRAINT FKRKJVHRTXR6P31WQBO399FCE26 FOREIGN KEY(DEFINITION_ID) REFERENCES DPV_REFERENCE_OBJECTS(ID);
