...
CREATE TABLE "PUBLIC"."DATA_PRODUCT_VERSIONS"(
...
ALTER TABLE "PUBLIC"."DATA_PRODUCT_VERSIONS" ADD CONSTRAINT "DPDS_DATA_PRODUCT_VERSIONS_PK" PRIMARY KEY ("DATA_PRODUCT_ID", "VERSION_NUMBER");


-- INFO_OWNERS

CREATE TABLE "PUBLIC"."INFO_OWNERS"(
    "ID"  VARCHAR(255) PRIMARY KEY,
    "NAME"  VARCHAR(255)
);

CREATE TABLE "PUBLIC"."INFO_CONTACT_POINTS"(
    "DATA_PRODUCT_ID" CHARACTER VARYING(255) NOT NULL,
    "VERSION_NUMBER" CHARACTER VARYING(255) NOT NULL,
    "NAME" CHARACTER VARYING(255),
    "DESCRIPTION" CHARACTER VARYING(255),
...
ALTER TABLE "PUBLIC"."DPDS_COMPONENT_TEMPLATE" ADD CONSTRAINT "CONSTRAINT_DPDS_COMPONENT_TEMPLATE_FK" FOREIGN KEY("TEMPLATE_ID") REFERENCES "PUBLIC"."DPDS_TEMPLATE"("ID");