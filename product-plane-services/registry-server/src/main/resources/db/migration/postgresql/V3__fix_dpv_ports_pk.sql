-- Step 1: Back up the existing data into temporary tables.
...
-- Step 7: Create a temporary mapping table for the old ID to new SEQUENCE_ID mapping.
...
-- Step 11: Optional cleanup of temporary tables.
